;;; bloodpad-theme.el --- Bloodpad Theme
...
;;; Commentary: A blood-red theme for a blood-red laptop.

;;; Code:
(require 'cl-lib)
(deftheme bloodpad)

(let ((colors '((dark_red     "#5E0000")
		(black        "#000000")
		(white        "#FFFFFF")
		(silver       "#b0b0b0")
		(alizarin     "#e74c3c")
		(fg1          "#FFFFFF")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
                (fg2          "#FFFFFF")
                (fg3          "#FFFFFF")
                (fg4          "#FFFFFF")
;;;	        (bg1          "#000000" "#000000")
      ...
      (faces '(;; default
               ...
               ;; isearch
               (isearch :bold t :foreground ,white :background ,dark_red)
               (isearch-fail :foreground ,white :background ,warning)
               ;; jde-java
               ...
               ;; mode-line
               (mode-line :foreground ,white :background ,dark_red :box ,white)
               (mode-line-inactive :foreground ,white :background ,dark_red :box ,white)
               ;; mu4e
               ...
               (org-document-title :weight bold :foreground ,white)
               (org-done :foreground ,comment)
               ...
               (org-level-1 :inherit bold :foreground ,alizarin :height 1.5)
               (org-level-2 :inherit bold :foreground ,alizarin :height 1.4)
               (org-level-3 :inherit bold :foreground ,alizarin :height 1.3)
               (org-level-4 :inherit bold :foreground ,alizarin :height 1.2)
               (org-level-5 :inherit bold :foreground ,alizarin :height 1.2)
               (org-level-6 :inherit bold :foreground ,alizarin :height 1.2)
               (org-level-7 :inherit bold :foreground ,alizarin :height 1.2)
               (org-level-8 :inherit bold :foreground ,alizarin :height 1.2)
               ...
               (org-todo :foreground ,white :bold t)
...
(provide-theme 'bloodpad)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; bloodpad-theme.el ends here
